...
/**
 * This class does the grouping work for different filterlists. Like if we i have 3 different filter
 * list and all have MUST_PASS_ALL condition finally this class groups the filters lists into one
 * filter list with all as MUST_PASS_ALL. Also it checks if the combination of the filters list is
 * given correctly. For eg: If i have c1 > 10 and c1 < 5. This is wrong combination.
 */
