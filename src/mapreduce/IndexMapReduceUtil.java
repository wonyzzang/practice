...
public class IndexMapReduceUtil {
	...
	public static IndexedHTableDescriptor getTableDescriptor(String tableName, Configuration conf) throws IOException {
	...
	public static List<Delete> getIndexDelete(Delete userDelete, Configuration conf) throws IOException {
		String tableName = conf.get(TableInputFormat.INPUT_TABLE);
		IndexedHTableDescriptor tableDescriptor = getTableDescriptor(tableName, conf);
	...
	public static byte[] getStartKey(Configuration conf, String tableName, byte[] row) throws IOException {
